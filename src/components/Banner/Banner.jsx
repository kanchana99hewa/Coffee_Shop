                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <div className="pl-4 border-l-4 border-primary/50">
                    ...
                    <p className="text-sm" style={{ color: '#fff' }}>
                      ...
                      At Coffee Café, we believe that a great cup of coffee is more than just a drink—it’s an experience. Founded with a passion for crafting the perfect brew, our café is a haven for coffee lovers and enthusiasts alike. We source our beans from the finest farms, ensuring that every sip offers a unique blend of rich flavors and aromas. Whether you’re stopping by for a quick espresso or settling in for a relaxed afternoon with friends, we’re dedicated to making your visit memorable. Our cozy atmosphere, friendly staff, and dedication to quality make Coffee Café the perfect spot to unwind and savor the art of coffee.
                    </p>
                  </div>
                </div>
              </div>
