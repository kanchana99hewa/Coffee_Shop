...
const MainSection = () => {
  ...
  <h2 className="mb-10 ml-8 text-5xl font-semibold leading-relaxed text-center"> {/* Adjusted leading and margin */}
  ...
  <button className="px-8 py-3 mt-4 text-xl text-black bg-yellow-600 rounded-full hover:bg-yellow-700"> {/* Reduced margin-top */}
    Order Now
  </button>
</div>
